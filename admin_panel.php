    ...
    <div class="main-content" id="main-content">
      <div class="marketplace" id="unexShop">
        <div class="header-marketplace">
          <h1><i class='fa-solid fa-user-tie'></i> Admin panel</h1>
          <span>panel de administradores de Unex</span>
        </div>
        <h2>Reportes</h2>
        <table border="1">
  <thead>
    <tr>
      <th>ID</th><th>Tipo</th><th>Reportado ID</th><th>Motivo</th><th>Reportado Por</th><th>Estado</th><th>Fecha</th><th>Acción</th>
    </tr>
  </thead>
